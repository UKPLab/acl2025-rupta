...
#SBATCH --output=/ukp-storage-1/yang/LLM_Anonymization/llm_annom_privacy_evaluation_out_wiki_test_gpt4_nu_sample5.txt
...
python /ukp-storage-1/yang/LLM_Anonymization/main.py --run_name evaluate_reflexion_wiki_gpt4_nu_sample5 --root_dir root --dataset_path /ukp-storage-1/yang/LLM_Anonymization/root/test_reflexion/t-test/wiki/gpt4-nu_5.jsonl --strategy test-acc --language wiki --pe_model gpt4-turbo-128k --pass_at_k 1 --max_iters 5 --verbose --p_threshold 3 --mem 3 --rag_data_path ./benchmarks/Wiki_People/All_data_for_retrieval.jsonl --rag_embed_cache_dir /home/ember/Desktop/work_space/Anonymization_Experiments/cache_emb --rag_num 5 --act_model meta-llama/Llama-2-70b-chat-hf --parser_model gpt-35-turbo-0301 --ue_model gpt4-turbo-128k
